  ...
  public render(): React.ReactElement<IReactMyGroupsProps> {
    ...
    return (
      <div className={styles.reactMyGroups} style={{ backgroundColor: semanticColors.bodyBackground }}>
        ...
        {(this.props.toggleSeeAll === false && !!this.props.seeAllLink && this.props.numberPerPage<totalItems) && <a aria-label={this.strings.seeAllLabel} href={this.props.seeAllLink}><div className={styles.seeAll}>{this.strings.seeAll}</div></a>}
